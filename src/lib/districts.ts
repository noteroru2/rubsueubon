  ...
  return [
    {
      ...
      answer: `มีครับ เราให้บริการรับซื้อและรับเทิร์นสินค้าไอทีในอำเภอ${name} อุบลราชธานี สามารถนัดรับสินค้าถึงที่หรือตกลงจุดนัดพบที่สะดวก แอด LINE @buyhub เพื่อประเมินราคาฟรีได้ทันที สอบถามรายละเอียดการนัดรับก่อนยืนยันนัดหมาย`,
    },
    {
      question: `รับซื้อโทรศัพท์มือถือ อำเภอ${name} ราคาเท่าไหร่?`,
      answer: `ราคารับซื้อขึ้นอยู่กับรุ่น สภาพ และอุปกรณ์ที่มาพร้อมเครื่อง ส่งรูปมาที่ LINE @buyhub ตอบ LINE 24 ชั่วโมง ประเมินเบื้องต้นฟรี ยืนยันราคาและเงื่อนไขหลังตรวจสินค้าจริง แจ้งพื้นที่ที่สะดวกในอำเภอ${name}`,
    },
    {
